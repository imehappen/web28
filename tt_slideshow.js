...
(function ($) {
  ...
  $.fn.TTSlider = function (settings) {
    ...
    if (
      ...
      transitionEffect == "SlideBottom"
    ) {
      var list = currentSlide
    ...
    $.fn.TTSlider.button();
    if (!stopTransition) {
      _bgStretcherTm = setTimeout(
        "jQuery.fn.TTSlider.slideShow('" +
          jQuery.fn.TTSlider.settings.sequenceMode +
          "', -1)",
        timeout,
      );
    }
  ...
  $.fn.TTSlider.effectNone = function (current, next) {
    ...
    var slides = $(
      "#" + element.attr("id") + " > ul li:lt(" + next.index() + ")",
    );
  ...
  $.fn.TTSlider.effectPixelate = function (current, next) {
    ...
    next.show(10, function () {
      ...
      window.img.src = next
        ...
        .replace(/^url\(['"]?/, "")
        .replace(/['"]?\)$/, "");
      ((v = Math.min(25, parseInt(25, 10))), (dx = 0.3));
      anim();
    });
 ...
 setTimeout('jQuery.fn.TTSlider.slideShow(\''+jQuery.fn.TTSlider.settings.sequenceMode+'\', -1)',(timeout * 1000));
      ...
      (function () {
        ...
        var x = $(
          '<div class="' +
            ...
            '"><a id="pag' +
            slideLabel +
            '"href="javascript:void(0);" class="pg">' +
            slideLabel +
            "</a></div>",
        );
        x.click(function () {
          ...
          $.fn.TTSlider.slideShow(
            $.fn.TTSlider.settings.sequenceMode,
            closureCount,
          );
        });
        $("#nav").append(x);
  ...
  $.fn.TTSlider.button = function () {
    var x = $(
      '<a id="prev" style="border:none;" href="javascript:void(0);"><span>previous</span></a>',
    );
    var y = $(
      '<a id="next" style="border:none;" href="javascript:void(0);"><span>next</span></a>',
    );
    var slides = $("." + $.fn.TTSlider.settings.cssPrefix + "slide");
    var numberOfSlides = slides.length;
    x.click(function () {
  ...
  $.fn.TTSlider.effectForeground = function (div1) {
    ...
    var listing1 = div1
      .find("." + prefix + "slideshow_element_alignment")
      .children();
          ...
          if (bottomm != "auto") {
            ...
            if (effectt == "Fade") {
              $(this)
                ...
                .delay(t)
                .fadeIn(1000)
                .animate({ bottom: bottomm }, d, easingg);
            } else {
              $(this)
                .css({ bottom: bottom + "px" })
                .delay(t)
        ...
        case "left,top":
          if (bottomm != "auto") {
            ...
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: "100%", bottom: bottom + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, bottom: bottomm }, d, easingg);
              } else {
                $(this)
                  .css({ right: "100%", bottom: bottom + "px" })
                  .delay(t)
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -w + "px", bottom: bottom + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, bottom: bottomm }, d, easingg);
              } else {
                $(this)
                  .css({ left: -w + "px", bottom: bottom + "px" })
                  .delay(t)
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -f_height + "px", bottom: bottom + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, bottom: bottomm }, d, easingg);
              } else {
            ...
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: "100%", top: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, top: topp }, d, easingg);
              } else {
                $(this)
                  .css({ right: "100%", top: -f_height + "px" })
                  .delay(t)
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -w + "px", top: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, top: topp }, d, easingg);
              } else {
                $(this)
                  .css({ left: -w + "px", top: -f_height + "px" })
                  .delay(t)
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -f_height + "px", top: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, top: topp }, d, easingg);
              } else {
        ...
        case "right,top":
          if (bottomm != "auto") {
            ...
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: -w + "px", bottom: bottom + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, bottom: bottomm }, d, easingg);
              } else {
            ...
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: -w + "px", top: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, top: topp }, d, easingg);
              } else {
        ...
        case "left,bottom":
          if (bottomm != "auto") {
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: "100%", bottom: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, bottom: bottomm }, d, easingg);
              } else {
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -w + "px", bottom: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, bottom: bottomm }, d, easingg);
              } else {
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: -f_height + "px", bottom: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, bottom: bottomm }, d, easingg);
              } else {
        ...
        case "right,bottom":
          if (bottomm != "auto") {
            if (left == "auto") {
              if (effectt == "Fade") {
                $(this)
                  .css({ right: -w + "px", bottom: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ right: right, bottom: bottomm }, d, easingg);
              } else {
              ...
              if (effectt == "Fade") {
                $(this)
                  .css({ left: "100%", bottom: -f_height + "px" })
                  .delay(t)
                  .fadeIn(1000)
                  .animate({ left: left, bottom: bottomm }, d, easingg);
              } else {
